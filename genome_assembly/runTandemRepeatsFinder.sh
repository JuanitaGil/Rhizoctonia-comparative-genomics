...
/path/to/trf409.linux64 /path/to/assembly.fasta 2 7 7 80 10 20 50 -h -ngs | awk '{if(substr($0,1,1)=="@") c=substr($1,2);else print c,$0}' > assembly_trf_2_7_7_80_10_20_50.txt
...
awk '{if( $4==1 || $4==2 || $5>=3 || $9>40 ) print $0}' assembly_trf_2_7_7_80_10_20_50.txt > assembly_trf_2_7_7_80_10_20_50_filtered.txt
